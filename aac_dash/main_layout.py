            ...
            dbc.Row(
                [
                    dbc.Col(
                        [
                            html.H3(
                                children="Aperçu des candidatures",
                                style={"textAlign": "center"},
                            )
                        ],
                        width=9,
    ...
    [
        dbc.Form(
            [
                dbc.FormGroup(
                    [
                        html.H5(children="évaluation", className="card-title"),
                        dcc.Markdown(
                            """
                ...
                dbc.FormGroup(
                    [
                        ...
                        dcc.Checklist(
                            id="coup-de-coeur",
                            options=[{"label": "Coup de coeur", "value": "1"}],
                            inputStyle={"margin-right": "10px", "margin-left": "10px"},
                        ),
                        html.Br(),
                    ]
                ...
                dbc.FormGroup(
                    [
                        dcc.Markdown("**Priorisation de la candidature :**"),
                        dcc.RadioItems(
                ...
                dbc.FormGroup(
                    [
                        dcc.Markdown("**Statut de la candidature :** "),
                        dcc.RadioItems(
                ...
                dbc.FormGroup(
                    [
                        dcc.Markdown("**Communication / Echanges en cours :**"),
                        dcc.RadioItems(
    ...
    [
        ...
        dbc.Modal(
            [
                ...
                dbc.ModalFooter(dbc.Button("Fermer", id="close", className="ml-auto")),
            ],
            id="modal",
                ...
                [
                    dbc.Row(
                        [
                            ...
                            dbc.Col([evaluation], width=6, align="right"),
                        ],
                        align="right",
                    ),
                    html.Br(),
